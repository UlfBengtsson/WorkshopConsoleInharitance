...
namespace ConsoleInharitance
{
    class Program
    {
        ...
        {
            //Shape shape = new Shape(1.1, 2.2);// can´t be done
            Shape rect = new Rectangle(1.1, 2.2);

            Console.WriteLine(Math.Round(rect.Area,3));

            Shape cube = new Cube(2, 2, 2);

            Console.WriteLine(cube.Area);

            if (cube is Cube)
            {
                Cube realCube = cube as Cube;
                Console.WriteLine(realCube.Volume());
            }

            ConsoleKeySwitch();
        }

        static void ConsoleKeySwitch()
        {
        ...
        static void DangerusThings()
        {
            ...
            List<IDangerus> dangerusThings = new List<IDangerus> { mushroom, bladePen};
        ...
        static void Pens()
        {
            ...
            List<Pen> penCase = new List<Pen> { whiteboardPen, normalPen, bladePen };
